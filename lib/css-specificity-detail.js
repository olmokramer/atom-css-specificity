...
import {addEventListener, highlightSelector, cssClassForSpecificityType} from './utils.js';
...
Object.assign(prototype, {
  ...
  specificityTypeBlock(specificity, label) {
    return `
      <div class="inline-block padded highlight-${cssClassForSpecificityType(label)}">
        <h1>${specificity}</h1>
        <p>${label}</p>
      </div>
    `;
